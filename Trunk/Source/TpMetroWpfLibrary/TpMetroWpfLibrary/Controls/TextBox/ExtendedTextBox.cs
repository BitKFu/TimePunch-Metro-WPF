    ...
    public class ExtendedTextBox : System.Windows.Controls.TextBox, INotifyPropertyChanged
    {
        ...
        public ExtendedTextBox()
        {
            ...
            applyButton = new ApplicationBarIcon
                              {
                                  ImageSource = new BitmapImage(new Uri("/TpMetroWpfLibrary;component/Images/appbar.check.png", UriKind.RelativeOrAbsolute)),
            ...
            cancelButton = new ApplicationBarIcon
                               {
                                   ImageSource = new BitmapImage(new Uri("/TpMetroWpfLibrary;component/Images/appbar.cancel.png", UriKind.RelativeOrAbsolute)),
